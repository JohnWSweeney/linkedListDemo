...
std::vector<std::string> cdListFuncsInts = { "init", "addNodeFront", "addNodeBack", "returnPtrByPos" };
std::vector<std::string> cdListFuncsNoInts = { "returnPosByPtr", "clear", "isEmpty", "size", "print", "addNodes"};
